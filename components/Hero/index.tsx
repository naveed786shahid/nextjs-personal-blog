            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Building the future, one Web App at a time.
                </h1>
                <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  You Manage The Business, We Handle The Application We cover
                  all the bits and pieces needed to develop top-notch,
                  innovative digital products. From strategy to product design,
                  including Front-end and Back-end services, we got your back.
                  We code to very high standards and test continuously, which
                  creates easy-to-maintain high-quality products.
                </p>
