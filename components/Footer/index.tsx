            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Not only can we increase your velocity and decrease your cost,
                  but also tailor our flexible engagement models to your needs..
                </p>
                <div className="flex items-center">
                  <a
                    href="https://web.facebook.com/profile.php?id=100067639789830"
                  ...
                  <a
                    href="https://www.instagram.com/aho_tech/"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/company/aho-tech"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                    target="_blank"
                    rel="noreferrer"
